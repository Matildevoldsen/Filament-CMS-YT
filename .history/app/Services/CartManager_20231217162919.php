...
class CartManager implements CartInterface
{
    ...
    public function getCart()
    {
        ...
        return $this->cart = Cart::query()->with(['items.variant.media', 'items.variant.ancestorAndSelf', 'items.product'])->where('cart_id', $this->session->get(config('cart.session.cart_key')))->first();
    }
